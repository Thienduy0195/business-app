...
import springboot.com.businessapi.rest_api.dto.mail.EmailResponse;
...
public class EmailService implements EmailSender {
    ...
    @Override
    @Async
    public void buildAndSend(String to, String email) {
        try {
    ...
    @Override
    @Async
    public void externalSender(String ownerRef, String emailBody) {
